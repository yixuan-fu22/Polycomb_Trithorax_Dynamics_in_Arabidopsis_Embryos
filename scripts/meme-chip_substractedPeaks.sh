...
# input FASTA
fasta_folder="../results/substractedPeaks"
...
# outdir
outdir="../results/meme-chip_substractedPeaks"
mkdir -p ${outdir}

# individual results folder
x=${fasta%%.*} # a REG extract string before the first . # x is an intermediate variable
clusterDir=${x/"/"/"_"}
