# To annotate H3K27me3 peak with H3K4me3
#renv
library(renv)
#renv::init()
renv::activate()
...
peakFolder <- paste0("../results/bedtools_peaks_H3K27me3_intersect_H3K4me3")

# make a result dir
resDir <- paste0("../results/ChIPseeker_H3K27me3_intersect_H3K4me3_peaks")
if(!file.exists(resDir)){dir.create(resDir)}

c("WS_H3K27ME3_OVERLAPWITH_H3K4ME3", "MG_H3K27ME3_OVERLAPWITH_H3K4ME3",
