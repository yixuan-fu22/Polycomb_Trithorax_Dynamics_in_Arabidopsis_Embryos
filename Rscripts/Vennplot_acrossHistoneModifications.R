...
for(ids in list(
  c("WS_K4ME3", "WS_H2AUB", "WS_K27ME3"),
  c("MG_K4ME3", "MG_H2AUB", "MG_K27ME3"), 
  c("SDL_K4ME3", "SDL_H2AUB_REPMERGED", "SDL_H3K27ME3_newDataset")
)){
  print(ids)
}
...
for(ids in list(
  ...
  tissue <- unlist(str_split(ids[[1]], "_"))[1]
  ...
  png(file.path(resDir, paste0("vennplot_GRangesCounts_", tissue, ".png" )))
  grid.draw(venn.plot)
  dev.off()
