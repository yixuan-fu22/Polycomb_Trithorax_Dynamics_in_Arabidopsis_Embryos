# To annotate non-overlapping H2Aub peak between WS and MG
...
peakFolder <- paste0("../results/substractedPeaks")

# make a result dir
resDir <- paste0("../results/ChIPseeker_substractedPeaks")
if(!file.exists(resDir)){dir.create(resDir)}


id = "H2AUB_MG_substract_WS" # "H2AUB_WS_substract_MG"
id = "H2AUB_WS_substract_MG"
